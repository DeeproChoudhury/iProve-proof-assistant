...
export type Z3LowLevelType =
{
    ...
    mk_seq_last_index: (c: Z3_context, UNNAMED: Z3_ast, substr: Z3_ast) => Z3_ast;
    ...
    mk_re_power: (c: Z3_context, UNNAMED: Z3_ast, n: unsigned) => Z3_ast;
    ...
    eval_smtlib2_string: (UNNAMED: Z3_context, str: string) => Promise<string>;
    ...
    solver_propagate_consequence: (c: Z3_context, UNNAMED: Z3_solver_callback, fixed: Z3_ast[], eq_lhs: Z3_ast[], eq_rhs: Z3_ast[], conseq: Z3_ast) => void;
